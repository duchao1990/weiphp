...
angular.module('ion.ionBottomSheet', []).directive('ionBottomSheet', ['$document', function($document,$sce) {
        return {
            ...
            template: '<div class="keypad-sheet-backdrop">' +
                ...
                '</div>' +
                '</div>' +
                '<div class="row" data-ng-repeat="subButtons in buttons">' +
                '<div class="col" data-ng-repeat="button in subButtons"><a class="button {{button.btClass}}"  ng-click="buttonClicked(button)">{{button.btText}}</a></div>' +
                '</div>'+
                '</div>' +
                '</div>' +
                '</div>' +
