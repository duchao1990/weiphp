      ...
      <div class="data-table">
        <div class="table-striped">
          <table cellspacing="1">
            ...
            <!-- 列表 -->
            <tbody>
            <?php $list = C(); unset($list['SENSITIVE_WORDS']);foreach($list as $key=>$val) { ?>
              <tr>
                <td width="250"><?php echo ($key); ?></td>
                <td><?php if(is_array($val)) {var_export($val);}elseif(is_bool($val)){ echo $val? 'true':'false';}else{ echo ($val);} ?></td>
              </tr>
              <?php } ?>
