...
abstract class Controller {
	...
	private function initWeb($info) {
		...
		$guest_login = isset ( $access [$index_1] ) || isset ( $access [$index_2] ) || isset ( $access [$index_3] ) || $index_1 == 'admin/*/*' || $index_3 == 'home/addons/execute' || $index_2 == 'home/user/*' || $index_1 == 'web/*/*' || $index_1 == 'wap/*/*' || $index_1 == 'mall/*/*';
